...
Ready for next feature:
  /stp:build [NEXT FEATURE NAME from .stp/docs/PLAN.md]
...
- If between features: "/stp:build [next feature] — [1-line what it is]"
- If milestone complete: "Milestone [N] done. Start Milestone [N+1]: /stp:build [first feature]"
...
- No tests found — TDD is mandatory, run /stp:build to get back on track
