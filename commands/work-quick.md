...
|------|------|-------|-------------|
| 1. Context + UI/UX | `${CLAUDE_PLUGIN_ROOT}/references/work-quick-steps/step1-context.md` | ~108 | Read PLAN.md, PRD constraints, check design system |
| 2. Research | `${CLAUDE_PLUGIN_ROOT}/references/work-quick-steps/step2-research.md` | ~170 | Impact scan, upshift check, codebase + library research |
| 3. Plan | `${CLAUDE_PLUGIN_ROOT}/references/work-quick-steps/step3-plan.md` | ~49 | Present checklist for approval |
| 5. Build + Ship | `${CLAUDE_PLUGIN_ROOT}/references/work-quick-steps/step5-build.md` | ~528 | TDD, executor agents, QA, version bump, milestone check |
